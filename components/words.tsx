...
export default function Paragraph({ paragraph }: TParagraphProps) {
	...
	return (
		<>
			<p
				ref={container}
				className="text-[100px] lg:text-[70px] md:text-[60px] xm:text-[36px] sm:text-[40px] text-[#121212] font-bold leading-none tracking-tight text-center flex flex-wrap items-center justify-center">
				{words.map((word, i) => {
