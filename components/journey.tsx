...
export default function Journey() {
	...
	return (
		<motion.div
			id="our-ambition"
			className="w-full h-screen xm:h-fit sm:h-fit flex items-center justify-center rounded-[30px] py-10 bg-[#E0E0E0] transition-all duration-300 ease-linear mb-20"
